...
$date_enregistrement=date('Y-m-d');
              ...
              $insertion = $dbo->prepare("INSERT INTO client2(nom_client,Date_de_naisance,sexe,telephone,adresse,taille,poids,code_client,prenom,Objectif,Antecedents,date_enregistrement) values(?,?,?,?,?,?,?,?,?,?,?,?)");
              ...
              {?> <script type="text/javascript">
                     ...
                     setInterval(function () {
                            window.location.replace('fiche_identification_clientBasic.php')
