...
<head>
    ...
    <title>CEEC - Login / Register</title>
            ...
            <div class="wrap">
                ...
                <div class="content">
                    ...
                    <div id="slideshow">
                            <h3>CEEC</h3>
                        <div class="one">
                            <h2><span>DGDA</span></h2>

                            <img src="logo-dgda.jpg" width="200" height="200" style="border-radius: 100%;">
                            <p>Sign up to attend</p>
                        </div>
                        <div class="two">
                            <h2><span>OGEFREM</span></h2>
                            <img src="logo-ogefrem.jpg" width="200" height="200" style="border-radius: 100%;">
                            <p>Share your </p>

                        </div>
                        <div class="three">
                            <h2><span>DGI</span></h2>
                             <img src="logo-dgi.png" width="200" height="200" style="border-radius: 100%;">
                            <p> that share your interests</p>
                        </div>
                        <div class="four">
                            <h2><span>SNEL</span></h2>
                            <img src="logo-snel.jpg" width="200" height="200" style="border-radius: 100%;">
                            <p>Share your </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="user">
                    ...
                    <div class="form-wrap">
                        <!-- TABS -->
                    	<div class="tabs">
                            <h3 class="login-tab"><a class="log-in active" href="#login-tab-content"><span>Connexion<span></a></h3>
                    		<h3 class="signup-tab"><a class="sign-up" href="#signup-tab-content"><span>Inscription</span></a></h3>
                    	</div>
                        <!-- TABS CONTENT -->
                    	<div class="tabs-content">
                    		...
                    		<div id="login-tab-content" class="active">
                    			<form class="login-form" action="" method="post">
                    				<input type="text" class="input" id="user_login" autocomplete="off" placeholder="Email ou N° Téléphone" required="required">
                    				<input type="password" class="input" id="user_pass" autocomplete="off" placeholder="Mot de passe" required="required">
                    		...
                    		<div id="signup-tab-content">
                    			<form class="signup-form" action="" method="post">
                    				<input type="email" class="input" id="user_email" autocomplete="off" placeholder="Email ou N° Téléphone">
                    				<input type="text" class="input" id="user_name" autocomplete="off" placeholder="Nom utilisateur">

                                    <select class="input" id="pays" autocomplete="off" style="color:black;">
                                     <option>Choisir une nationalité</option>
                                     <option>Congolaise</option>
                                     <option>Angolaise</option>
                                     <option>Argentine</option>
                                     <option>Albanie</option>
                                    </select>

                                    <select class="input" id="categorie" autocomplete="off" style="color:black;">
