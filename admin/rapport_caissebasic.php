					...
					<div class="page-content">
						...
						<div class="row" style="background-color: grey; height: 1000px; ">
							...
							<div class="col-xs-8" style="background-color: white; height: 1000px; ">
								<!-- PAGE CONTENT BEGINS -->
<a href="rapport_chambre.php"><img src="logo/logo.png" style="border-radius: 90%; width: 15%;"></a>
<div class="clearfix">
...
<?php 
$requete2 = mysqli_query($connection,"SELECT *FROM  caisse_produis2 WHERE date_enregistrement between '$debut' and '$fin' ");
...
<?php }
 ...
 <?php 
$requete2 = mysqli_query($connection,"SELECT SUM(pu_usd) as usd FROM  caisse_produis2 WHERE date_enregistrement between '$debut' and '$fin'  and type_vente='cash'");
while ($garde = mysqli_fetch_assoc($requete2)) {  ?>
...
<?php }
 ...
 <?php 
$requete2 = mysqli_query($connection,"SELECT SUM(pu_cdf) as cdf FROM  caisse_produis2 WHERE date_enregistrement between '$debut' and '$fin'  and type_vente='cash'");
while ($garde = mysqli_fetch_assoc($requete2)) {  ?>
									<?php  $cdfx=$garde['cdf']; ?>
...
<?php }
 ...
 <?php 
$requete2 = mysqli_query($connection,"SELECT SUM(pu_usd) as usd FROM  caisse_produis2 WHERE date_enregistrement between '$debut' and '$fin' and type_vente='credit'");
while ($garde = mysqli_fetch_assoc($requete2)) {  ?>
...
<?php }
 ...
 <?php 
$requete2 = mysqli_query($connection,"SELECT SUM(pu_cdf) as cdf FROM  caisse_produis2 WHERE date_enregistrement between '$debut' and '$fin' and type_vente='credit'");
while ($garde = mysqli_fetch_assoc($requete2)) {  ?>
									<?php  $cdfxp=$garde['cdf']; ?>
...
<?php }
 ...
 <tr>
						<td><strong> Cash: <?php echo $usdx;  ?>$<br><?php echo $cdfx;  ?> FC</strong></td>
					</tr>

					 <tr class="red">
						<td><strong> Credit: <?php echo $usdxp;  ?>$<br><?php echo $cdfxp;  ?> FC</strong></td>
					</tr>
