...
<body>
		...
		<article>
			...
			<address class="norm">
				...
				<h4>Piece d'identité : <?php echo $garde['type_carte'].' N°: '.$garde['numero_identiter'] ?></h4>
				<p> Date d'arriver: <?php echo $garde['date_arriver']; ?></p>
				<p> Date du depart: <?php echo $garde['date_fin']; ?></p>
				<p> Nationnalité: <?php echo $garde['nationnalite']; ?>
			...
			<table class="inventory">
				<thead>
					<tr>
						...
						<th><span >Déscription</span></th>
						<th><span >Nbr Jr</span></th>
						<th><span >Prix Unit</span></th>
				...
				<tbody>
					<tr>
						...
						<td><span >Occupation de la chambre N°:<?php echo $chambres=$garde['chambres']; ?></span></td>
						<td><span ><?php echo $garde['total_jours']; ?></span></td>
						<td><span ><?php echo $garde['prix_chambre']; ?></span><span data-prefix>$</span></td>
	...
	<a href="dashboard.php"><img src="logo/malebo.png " style="border-radius: 100%; width: 70%;"></a></td>
			...
			<table class="balance">
				<tr>
					...
					<td><span><?php echo $garde['tot_a_payer']; ?></span><span data-prefix>$</span></td>
				</tr>
			</table>
		</article>
		<aside>
