...
$sql = mysqli_query($connection,"SELECT *FROM caisse_restaurant WHERE code_facture='$code_facture' group by code_facture");
			...
			<table class="inventory">
				<thead>
					<tr>
						...
						<th style="width:10%">Prix USD</th>
						<th style="width:10%">Prix FC</th>
                <th >Categories</th>
...
$sql = mysqli_query($connection,"SELECT *FROM caisse_restaurant WHERE code_facture='$code_facture'");
while ($garde = mysqli_fetch_assoc($sql)) { ?>
...
<tr>
	<td></td>
	<td><strong>Dollard:   <?php  $requete2 = mysqli_query($connection,"SELECT sum(prix_usd) as normale FROM caisse_restaurant WHERE code_facture='$code_facture' ");
...
echo number_format($nn,2); 
	...
	<td><strong>Franc:   <?php  $requete2 = mysqli_query($connection,"SELECT sum(prix_fc) as normale FROM caisse_restaurant WHERE code_facture='$code_facture' ");
                                     while ($garde = mysqli_fetch_assoc($requete2)) {
...
echo number_format($nn,2); 
	...
	<td>
			...
			<table class="sign">
				<tr>
					<td>
	<a href="dashboard.php"><?php include('logo/logo.php');?></a></td>
				</tr>
			</table>
<?php 
