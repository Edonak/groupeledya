...
if (isset($_GET['code_proforma'])) {
extract($_GET);




$sqls = mysqli_query($connection,"SELECT *FROM profrorma WHERE code_proforma='$code_proforma' group by code_proforma");
while ($gardess = mysqli_fetch_assoc($sqls)){
   $client=$gardess['client']; 

   $code_proforma=$gardess['code_proforma']; 

}
$sql = mysqli_query($connection,"SELECT *FROM profrorma WHERE code_proforma='$code_proforma'");
		...
		<article>
			...
			<table class="meta">
				<tr>
					...
					<td><span ><?php echo $code_proforma; ?></span></td>
				</tr>
				<tr>
			...
			<table class="inventory">
				<thead>
					<tr>
						<th><span >Date Opération</span></th>
						
						
						<th><span >Motif</span></th>
						<th><span >Montant</span></th>
						<th><span >Percepeteur</span></th>
					...
					<tr>
					 <td><?php echo $garde['date_operation']; ?></td>
                       ...
                       <td><?php echo $garde['montant']; ?>$</td>
                        ...
                        <td class="hidden-480"><?php echo $garde['percepteur'];  ?>
	...
	<a href="dashboard.php"><img src="logo/malebo.png " style="border-radius: 100%; width: 70%;"></a></td>
			...
			<table class="balance">
				<tr>
					...
					<td><span><?php  $requete2 = mysqli_query($connection,"SELECT sum(montant) as normale FROM profrorma where code_proforma='$code_proforma' ");
