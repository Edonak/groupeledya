                             ...
                             <div class="col-xs-12">
                                <div class="row">
                                      ...
                                      <div>
                                          <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                                 <thead>
                                                       ...
                                                       <th>Evenement</th>
                                                       <th class="hidden-480">Date evenement</th>
                                   ...
                                   <tbody>
                                     ...
                                     <?php 
                                     $requete2 = mysqli_query($connection,"SELECT *FROM caisse where motif='location de la salle' ORDER BY id DESC");
                                     while ($garde = mysqli_fetch_assoc($requete2)) {  ?>
                                           ...
                                           <tr>
                                               ...
                                               <td><?php echo $garde['date_event']; ?></td>
                                             ...
                                             <td>
                                                    <div class="hidden-sm hidden-xs action-buttons">
                                                          <a class="blue" href="impression_fac_salle.php?id=<?php echo $garde['id']; ?>">
