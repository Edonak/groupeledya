                             ...
                             <div class="col-xs-12">
                                <div class="row">
                                      ...
                                      <div>
                                          <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                                 <thead>
                                                       ...
                                                       </th><th>Date Opération</th>
                                                       <th>Code opération</th>
                                                       <th>Noms Client</th>
                                                       
                                                       
                                                       <th class="hidden-480">Motif</th>
                                   ...
                                   <tbody>
                                     ...
                                     <?php 
                                     $requete2 = mysqli_query($connection,"SELECT *FROM profrorma group by code_proforma ORDER BY id DESC");
                                     while ($garde = mysqli_fetch_assoc($requete2)) {  ?>
                                           ...
                                           <tr>
                                               ...
                                               <td><?php echo $garde['code_proforma']; ?></td>
                                               <td class="hidden-480"><?php echo $d = $garde['client']; ?></td>
                                             ...
                                             <td>
                                                    <div class="hidden-sm hidden-xs action-buttons">
                                                          <a class="blue" href="voir_proformat.php?code_proforma=<?php echo $garde['code_proforma']; ?>">
...
<a href="" class="btn btn-app btn-warning radius-7">
    ...
    <span class="badge badge-primary badge-right">
          <?php 
          $query5 = mysqli_query($connection,"SELECT COUNT(code_proforma) AS nbr FROM profrorma group by code_proforma ");
