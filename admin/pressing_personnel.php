...
if (isset($_GET['imp'])) {
       ...
       $sqll=mysqli_query($connection,"UPDATE caisse_pressing SET position=1,tache='$username' where code_facture='$imp' ");
       ...
       {?> <script type="text/javascript">
                     ...
                     setInterval(function () {
                            window.location.replace('pressing_personnel.php')
...
setInterval('load_message()',10000);
