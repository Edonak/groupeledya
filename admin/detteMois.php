   ...
   <div class="col-xs-12">
     ...
     <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                   ...
                   <?php 
                   $requete2 = mysqli_query($connection,"SELECT * FROM detteclient  ORDER by id DESC");
                   while ($garde = mysqli_fetch_assoc($requete2)) {  ?>

                  
                     <tr>
                         <td><a href="#"><?php echo $garde['nomClient'] ?></a></td>
   <td><a href="#"><?php echo $garde['montant_a_payer'] ?></a></td>
   <td><?php echo $garde['montant_payer']; ?></td>

                        

                        <td>
                            
                                <p style=" color: red; "><?php echo $garde['montant_restant']; ?></p>
                        ...
                        <td>
                            <div class="hidden-sm hidden-xs action-buttons">
                             <a class="blue" href="detteMois.php?dette=<?php echo $garde['codeDette']; ?>" >
...
$requeteAAA1=mysqli_query($connection,"DELETE FROM detteclient where codeDette='$dette' ");
{?> <script type="text/javascript">
   window.location.replace('detteMois.php')
</script>
