            ...
            <div class="row">
                <div class="col-xs-12">
                   <div class="clearfix">
                      ...
                      <div class="logolg">
                       <img src="logo/valeriia.jpg" style="background-repeat: repeat; width:175%; align:center;">
                           </div>
...
$qte_cart=1;
$insertion = $dbo->prepare("INSERT INTO  caisse_produis(service,pu_usd,qte_cart,username,date_enregistrement,prix) values(?,?,?,?,?,?)");
...
if ($categorie=='moitie') {
   $montant=$prix/2;
    $requeteAAA = mysqli_query($connection,"UPDATE caisse_produis SET montant='$montant',etat=1 where etat=0");
}elseif ($categorie=='payant') {
   $montant=$prix*1;
    $requeteAAA = mysqli_query($connection,"UPDATE caisse_produis SET montant='$montant',etat=1 where etat=0");
}elseif ($categorie=='non payant') {
$montant=$prix*0;
    $requeteAAA = mysqli_query($connection,"UPDATE caisse_produis SET montant='$montant',etat=1 where etat=0");
}
...
if (isset($_POST['valider'])  ) {
 ...
 $requete2 = mysqli_query($connection,"SELECT *FROM fiche where code_fiche='$cat' ");
 while ($garde = mysqli_fetch_assoc($requete2)) {


$categorie= $garde['categorie']; 
$nom_complet= $garde['nom_complet']; 
 



    $requeteAAA = mysqli_query($connection,"UPDATE caisse_produis SET categorie='$categorie',nom='$nom_complet' where etat=0");
