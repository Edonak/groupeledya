					...
					<div class="page-content">
						...
						<div class="row" style="background-color: grey; height: 1000px; ">
							...
							<div class="col-xs-8" style="background-color: white; height: 1000px; ">
								<!-- PAGE CONTENT BEGINS -->
<a href="rapport_ordonance.php"><img src="icones/WhatsApp Image 2023-05-30 at 20.25.24.jpeg" style="border-radius: 100%; width: 15%;"></a>
<div class="clearfix">
...
<?php 
$requete2 = mysqli_query($connection,"SELECT *FROM  ordonances WHERE date_enregistrement between '$debut' and '$fin' ");
...
<?php echo $garde['docteur'];?>		<span class="lbl"></span></label></td>
		<td><?php echo $garde['code_facture']; ?></td>
	
		
<td class="hidden-480"><?php echo $garde['nom_produits']; ?></td>
		<td><?php echo $garde['dosage']; ?></td>

<td class="hidden-480"><?php echo $garde['type_produits']; ?></td>

<td><?php echo $usds=$garde['posologie']; ?></td>
<td><?php echo $usds=$garde['nom']; ?></td>
