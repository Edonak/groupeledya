...
$qte=$gardeS['qte_cart'];  }
 ...
 $tot=$qte+$qte_cart;
     ...
     $requeteAAA = mysqli_query($connection,"UPDATE appro SET qte_cart='$tot' where id='$id_produit' ");
...
if ( $qte!=0) {?>
                                           ...
                                           <tr>
                                               ...
                                               <td><a href="vente.php?caisse=<?php echo $garde['id']; ?>"><?php echo $garde['nom_produits']; ?> </a></td>
...
if (isset($_GET['caisse'])) {
       extract($_GET);
        ...
        $requete2 = mysqli_query($connection,"SELECT *FROM appro where id='$caisse' ORDER BY id DESC");
                                            while ($garde = mysqli_fetch_assoc($requete2)) {
...
$id_produit=$garde['id'];
     ...
     $requeteAAA = mysqli_query($connection,"UPDATE appro SET qte_cart='$tot' where id='$caisse' ");
$perimer='non';
  $insertion = $dbo->prepare("INSERT INTO  caisse_produis(nom_produits,pu_usd,pu_cdf,qte_cart,lot,perimer,type_produits,id_produit) values(?,?,?,?,?,?,?,?)");

              $insertion->execute(array($nom_produits,$pu_usd,$pu_cdf,$qte_cart,$lot,$perimer,$type_produits,$id_produit));
...
$code_facture=mt_rand();
     ...
     $requeteAAA = mysqli_query($connection,"UPDATE caisse_produis SET etat=1,code_facture='$code_facture' where etat=0 ");
