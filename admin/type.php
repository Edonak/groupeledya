...
if (isset($_GET['sup'])) {
       ...
       $sqll=mysqli_query($connection,"DELETE FROM type where id='$sup' ");
       ...
       <?php }
                                            ...
                                            $requete2 = mysqli_query($connection,"SELECT *FROM type ORDER BY id DESC");
                                                  ...
                                                  <tr>
                                                   ...
                                                   <td>
                                                        <div class="hidden-sm hidden-xs action-buttons">
                                                           <a class="red" href="type.php?sup=<?php echo $garde['id']; ?>">
...
<div class="col-lg-5">
  ...
  $insertion = $dbo->prepare("INSERT INTO type(nom) values(?)");
       ...
       <div class="clearfix form-actions">
              <div class="col-md-offset-1 col-md-9">
                    ...
                    <div class="form-group">
                     ...
                     <div class="col-sm-9">
                            <input type="text" id="form-field-1-1" name="nom" placeholder="Nom du produits" class="form-control" />
                     </div></div>
