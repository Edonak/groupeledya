...
if (isset($_GET['supprime'])) {
       ...
       $sqll=mysqli_query($connection,"DELETE FROM client2 where code_client='$supprime' ");
...
?>
     ...
     <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                   ...
                   <?php 
                   $requete2 = mysqli_query($connection,"SELECT * FROM client2 ORDER by id DESC");
   ...
   <td><?php echo $garde['Date_de_naisance']; ?></td>

                        

                        <td>
                            <?php echo $garde['telephone']; ?>

</td>
<td>
        <?php echo $garde['Objectif']; ?>

</td>

<?php if ($service=="DG" ) { ?>
<td>
        <center><a href="clientBasic.php?supprime=<?php  echo $code_client ?>" ><i class="fa fa-trash-o" style=" color:red;"></i></a></center>
</td>
<?php } ?>
<td>
        <center><a href="#"><i class="fa fa-edit"></i></a></center>
