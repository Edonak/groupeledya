...
if (isset($_GET['supprime'])) {
       ...
       $sqll=mysqli_query($connection,"DELETE FROM client where code_client='$supprime' ");
...
?>
     ...
     <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                   ...
                   <?php 
                   $requete2 = mysqli_query($connection,"SELECT * FROM client ORDER by id DESC");
...
<?php if ($service=="DG" ) { ?>
<td>
        <center><a href="services.php?supprime=<?php  echo $code_client ?>" ><i class="fa fa-trash-o" style=" color:red;"></i></a></center>
</td>
<?php } ?>
<td>
