                                     ...
                                     <div class="clearfix">
                                      ...
                                      <div>
                                          <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                                 ...
                                                 <th class="hidden-480">Description de l'evenement</th>
                                   ...
                                   <tbody>
                                     ...
                                     while ($garde = mysqli_fetch_assoc($requete2)) {  ?>
                                           ...
                                           <tr>
                                               ...
                                               <td class="hidden-480">
                                                <span class="">
                                                      <?php echo $garde['description_evenement'];  ?>
                                             ...
                                             <td>
                                                    <div class="hidden-sm hidden-xs action-buttons">
                                                          <a class="blue" href="voir_fiche_salle.php?id=<?php echo $garde['id']; ?>">
...
<a href="" class="btn btn-app btn-warning radius-7">
    ...
    <span class="badge badge-primary badge-right">
          <?php 
          $query5 = mysqli_query($connection,"SELECT COUNT(id) AS nbr FROM salle ");
