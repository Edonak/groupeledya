...
$nombre_jours= $garde['nombre_jours']; 
    ...
    $requeteAAA = mysqli_query($connection,"UPDATE abonnement SET etat=1,libelle='$libelle',prix='$prix',nmbr_jr='$nombre_jours' where etat=0");
    $requeteAAA = mysqli_query($connection,"UPDATE client SET etat=1  where etat=0");
      ?> <script type="text/javascript">
