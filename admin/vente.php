...
if (isset($_GET['sup'])) {
 ...
 $requete2 = mysqli_query($connection,"SELECT *FROM caisse_produis where id='$sup' ORDER BY id DESC");
...
$id_produit=$garde['id_produit'];  
 ...
 $requete2S = mysqli_query($connection,"SELECT *FROM appro where id='$id_produit' ORDER BY id DESC");
...
$qte=$gardeS['sortie'];  }
 ...
 $tot=$qte-$qte_cart;
     ...
     $requeteAAA = mysqli_query($connection,"UPDATE appro SET sortie='$tot' where id='$id_produit' ");


       $sqll=mysqli_query($connection,"DELETE FROM caisse_produis where id='$sup' ");
 ...
 ?>
                                   ...
                                   <tbody>
                                     ...
                                     <?php 
                                     $requete2 = mysqli_query($connection,"SELECT *FROM appro");
                                     while ($garde = mysqli_fetch_assoc($requete2)) {  ?>
...
if ($alerte==$total or $alerte>$total ) {
    $requeteAAA = mysqli_query($connection,"UPDATE appro SET position_alefte='oui' where id='$id_produitxxx' ");
}elseif ($alerte<$total) {
        $requeteAAA = mysqli_query($connection,"UPDATE appro SET position_alefte='non' where id='$id_produitxxx' ");
...
if ( $total!=0) {?>
                                           ...
                                           <tr>
                                               ...
                                               <td><a href="vente.php?caisse=<?php echo $garde['id']; ?>"><h4><?php echo $garde['nom_produits']; ?>  </h4> </a></td>
...
<td>   <a class="red" href="vente.php?cash=<?php echo $garde['id']; ?>">
                                             ...
                                             <td>
                                                    <div class="hidden-sm hidden-xs action-buttons">
                                                                       ...
                                                                       <a class="blue" href="vente.php?credit=<?php echo $garde['id']; ?>" >
...
if (isset($_GET['cash'])) {
       extract($_GET);
        ...
        $requete2 = mysqli_query($connection,"SELECT *FROM appro where id='$cash' ORDER BY id DESC");
                                            while ($garde = mysqli_fetch_assoc($requete2)) {
...
$sortieq=$garde['sortie'];
 ...
 $requeteAAA = mysqli_query($connection,"UPDATE appro SET sortie='$sortiex' where id='$cash' ");
$perimer='non';
  $insertion = $dbo->prepare("INSERT INTO  caisse_produis(nom_produits,pu_usd,pu_cdf,qte_cart,lot,perimer,type_produits,id_produit,username,date_enregistrement,type_vente) values(?,?,?,?,?,?,?,?,?,?,?)");
...
if (isset($_GET['credit'])) {
       extract($_GET);
        ...
        $requete2 = mysqli_query($connection,"SELECT *FROM appro where id='$credit' ORDER BY id DESC");
                                            while ($garde = mysqli_fetch_assoc($requete2)) {
...
$sortieq=$garde['sortie'];
 ...
 $requeteAAA = mysqli_query($connection,"UPDATE appro SET sortie='$sortiex' where id='$credit' ");
$perimer='non';
  $insertion = $dbo->prepare("INSERT INTO  caisse_produis(nom_produits,pu_usd,pu_cdf,qte_cart,lot,perimer,type_produits,id_produit,username,date_enregistrement,type_vente) values(?,?,?,?,?,?,?,?,?,?,?)");
...
$datess=date('l');
    ...
    include("Qr code/libs/phpqrcode/qrlib.php");
     ...
     $requeteAAA = mysqli_query($connection,"UPDATE caisse_produis SET etat=1,code_facture='$filenamex',qrcode='$lienqr' where etat=0 ");
  ...
  <tbody>
       <?php 
                                     $requete2 = mysqli_query($connection,"SELECT *FROM caisse_produis where etat=0  ORDER BY id DESC");
                                     while ($garde = mysqli_fetch_assoc($requete2)) {  ?>
...
<td class="hidden-480"><?php echo $garde['type_vente']; ?> </td>
                                                      ...
                                                      <td><a class="red" href="vente.php?sup=<?php echo $garde['id']; ?>"><i class="ace-icon fa fa-trash bigger-130"></i></a> </td>
  </tr>
     <?php }
...
<footer>
    <tr>
        <td>TOTAL</td>
        <td><strong>PRIX TOTAL USD:   <?php  $requete2 = mysqli_query($connection,"SELECT sum(pu_usd) as normale FROM caisse_produis where etat=0 ");
                                     while ($garde = mysqli_fetch_assoc($requete2)) {
...
echo number_format($nn,1); 
                                      ...
                                      ?>$</strong></td>
                                         ...
                                         <td><strong>PRIX TOTAL FC:   <?php  $requete2 = mysqli_query($connection,"SELECT sum(pu_cdf) as normale FROM caisse_produis where etat=0 ");
                                     while ($garde = mysqli_fetch_assoc($requete2)) {
