...
<div class="row">
   <div class="col-xs-12">
     ...
     <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                   ...
                   <?php 
                   $requete2 = mysqli_query($connection,"SELECT * FROM abonnement WHERE etat=1 AND Argent_restant>0 ORDER by id DESC");
   ...
   <td><?php echo $garde['libelle']; ?></td>
                        ...
                        <td>
                                ...
                                <p style=" color: red; "><?php echo $garde['prix']; ?></p>
                           
                            
                        </td>
                          <td><?php echo $garde['Argent_recu']; ?></td>
                           <td><?php echo $garde['Argent_restant']; ?></td>
                            
                        <td>
                            <div class="hidden-sm hidden-xs action-buttons">
                             <a class="blue" href="dette1.php?dette=<?php echo $garde['code_client']; ?>" >
                               <i class="ace-icon fa fa- bigger-130"> <img src="icones/icons8_dollar_banknote_32.png" style="width:75%" style="color: red;"></i></a>
...
if (isset($_GET['dette'])) {
 ...
 $requete2 = mysqli_query($connection,"SELECT *FROM abonnement where code_client='$dette' ORDER BY id DESC");
 while ($garde = mysqli_fetch_assoc($requete2)) {
...
$requeteAAA = mysqli_query($connection,"UPDATE abonnement SET prix='$prix',Argent_recu='$prix',Argent_restant=0 where code_client='$dette'");
{?> <script type="text/javascript">
    window.location.replace('dette1.php')
</script>
