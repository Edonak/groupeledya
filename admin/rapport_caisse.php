...
<?php 
$requete2 = mysqli_query($connection,"SELECT *FROM  caisse_produis WHERE date_enregistrement between '$debut' and '$fin' ");
...
<?php }
 ...
 <?php 
$requete2 = mysqli_query($connection,"SELECT SUM(pu_usd) as usd FROM  caisse_produis WHERE date_enregistrement between '$debut' and '$fin'  and type_vente='cash'");
while ($garde = mysqli_fetch_assoc($requete2)) {  ?>
...
<?php }
 ...
 <?php 
$requete2 = mysqli_query($connection,"SELECT SUM(pu_cdf) as cdf FROM  caisse_produis WHERE date_enregistrement between '$debut' and '$fin'  and type_vente='cash'");
while ($garde = mysqli_fetch_assoc($requete2)) {  ?>
									<?php  $cdfx=$garde['cdf']; ?>
...
<?php }
 ...
 <?php 
$requete2 = mysqli_query($connection,"SELECT SUM(pu_usd) as usd FROM  caisse_produis WHERE date_enregistrement between '$debut' and '$fin' and type_vente='credit'");
while ($garde = mysqli_fetch_assoc($requete2)) {  ?>
...
<?php }
 ...
 <?php 
$requete2 = mysqli_query($connection,"SELECT SUM(pu_cdf) as cdf FROM  caisse_produis WHERE date_enregistrement between '$debut' and '$fin' and type_vente='credit'");
while ($garde = mysqli_fetch_assoc($requete2)) {  ?>
									<?php  $cdfxp=$garde['cdf']; ?>
