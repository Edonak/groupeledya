...
<body>
		...
		<article>
			...
			<address class="norm">
				...
				<p> Evenement: <?php echo $garde['type_evenement']; ?><br>
				<p> Salle N°: <?php echo $garde['nominnation']; ?><br>
			...
			<table class="inventory">
				<thead>
					<tr>
						...
						<th><span >Date evenement</span></th>
				...
				<tbody>
					<tr>
						...
						<td><span ><?php echo $garde['date_event']; ?></span></td>
