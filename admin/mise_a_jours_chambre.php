                             ...
                             <div class="col-xs-12">
                                <div class="row">
                                      ...
                                      <div>
                                          <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                                 <thead>
                                                       ...
                                                       <th class="hidden-480">Montant payer</th>
                                                       <th class="hidden-480">Mode paiement/Motif</th>
                                   ...
                                   <tbody>
                                     ...
                                     <?php 
                                     $requete2 = mysqli_query($connection,"SELECT *FROM caisses ORDER BY id DESC");
...
<?php }else { ?>
                                           ...
                                           <tr>
                                               ...
                                               <td class="hidden-480"><?php echo $d = $garde['montant']; ?>$</td>
                                               <td class="hidden-480"><?php echo $garde['motif']; ?> <br><?php echo $garde['mode_paiement']; ?></td>
                                           ...
                                           <?php echo $garde['percepteur'];  ?>
                                             ...
                                             <td>
                                                    <div class="hidden-sm hidden-xs action-buttons">
                                                          ...
                                                          <a class="red" href="mise_a_jours_chambre.php?sup=<?php echo $code=$garde['id']; ?>" onclick="return confirm('Voulez-vous vraiment supprimer cet enregistrement ?');">
                                                                <i class="ace-icon fa fa-trash bigger-130"></i></a>


                                                          <a class="blue" href="mise_a_jours_chambre.php?num=<?php echo $code=$garde['id']; ?>">
...
if (isset($_GET['sup'])) {
       ...
       $sqll=mysqli_query($connection,"DELETE FROM caisses where id='$sup' ");
       ...
       {?> <script type="text/javascript">
                     ...
                     setInterval(function () {
                            window.location.replace('mise_a_jours_chambre.php')
...
if (isset($_POST['Modifier'])) {
       ...
       $sqll=mysqli_query($connection,"UPDATE caisses SET montant='$montant' where id='$num' ");
...
if (isset($_GET['num'])) {
       ...
       $requete2a = mysqli_query($connection,"SELECT *FROM caisses WHERE id='$num'");
...
<form class="form-horizontal" method="post"  role="form">
       ...
       <div class="clearfix form-actions">
              <div class="col-md-offset-1 col-md-9">
                    <h3>MODIFICATION DE L'INFORMATION</h3>
                     ...
                     <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                   ...
                                   <input type="hidden" id="form-field-1-1" value="<?php echo $bomba['id']; ?>" name="num" placeholder="Saisir le montant" class="form-control"  />



                                   <input type="text" id="form-field-1-1" value="<?php echo $bomba['montant']; ?>" name="montant" placeholder="Saisir le montant" class="form-control"  />
                            </div></div>

                            

                                   <input type="submit" name="Modifier" value="Modifier" class="btn btn-prymari btn-block">
