           ...
           <div class="col-xs-12">
            <div class="row">
                ...
                <tbody>
                   ...
                   <?php 
                   $requete2 = mysqli_query($connection,"SELECT *FROM client WHERE etat=0 ORDER BY id DESC");
   ...
   <td><?php echo $garde['Objectif']; ?></td>
                        ...
                        <td>
                            <div class="hidden-sm hidden-xs action-buttons">
                             <a class="blue" href="abonnement.php?credit=<?php echo $garde['code_client']; ?>" >
...
if (isset($_GET['credit'])) {
 ...
 $requete2 = mysqli_query($connection,"SELECT *FROM client where code_client='$credit' ORDER BY id DESC");
 while ($garde = mysqli_fetch_assoc($requete2)) {
...
$insertion = $dbo->prepare("INSERT INTO  abonnement(nom_client,Date_de_naisance,sexe,telephone,adresse,taille,poids,code_client,prenom,Objectif,Antecedents,date_enregistrement) values(?,?,?,?,?,?,?,?,?,?,?,?)");

$insertion->execute(array($nom,$data,$sexe,$telephone,$adresse,$taille,$poids,$credit,$prenom,$Objectif,$Antecedents,$date_enregistrement));
$requeteAAA = mysqli_query($connection,"UPDATE client SET etat=1  where code_client='$credit'");
{?> <script type="text/javascript">
    window.location.replace('abonnement.php')
</script>
...
if (isset($_GET['sup'])) {
     ...
     $sqll=mysqli_query($connection,"DELETE FROM abonnement where code_client='$sup' ");
...
if (isset($_POST['confirmer'])  ) {
 ...
 $requete2 = mysqli_query($connection,"SELECT *FROM tarif where code_tarif='$tarif' ");
 while ($garde = mysqli_fetch_assoc($requete2)) {
...
$nombre_jours= $garde['nombre_jours']; 
 ...
 $Argent_restant=$prix-$argentRecu;


     $requeteAAA = mysqli_query($connection,"UPDATE abonnement SET etat=1,libelle='$libelle',prix='$prix',Argent_recu='$argentRecu',Argent_restant='$Argent_restant',nmbr_jr='$nombre_jours' where etat=0"); 
...
<tbody>
 <?php 
 $requete2 = mysqli_query($connection,"SELECT *FROM abonnement where etat=0   ORDER BY id DESC");
 while ($garde = mysqli_fetch_assoc($requete2)) { 
$code=$garde['code_client'];
  ...
  <tr>
        ...
        <td><a class="red" href="abonnement.php?sup=<?php echo $code; ?>"><i class="ace-icon fa fa-trash bigger-130"></i></a> </td>
...
<?php }
 ...
 ?>
          ...
          <input type="text" name="argentRecu" placeholder="argent reçu"><br> <br>
