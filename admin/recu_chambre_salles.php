...
$sql = mysqli_query($connection,"SELECT *FROM caisses WHERE id='$id'");
...
$sqls = mysqli_query($connection,"SELECT *FROM salle WHERE code_facture='$code_facture'");
...
<tbody>
					<tr>
						...
						<td><span ><?php echo $t=$k-$s;?></span><span data-prefix>$</span></td>
	...
	<a href="dashboard.php"><img src="logo/malebo.png " style="border-radius: 100%; width: 70%;"></a></td>
			...
			<table class="balance">
				<tr>
					<th><span >Montant payer</span></th>
					<td><span><?php echo $garde['montant']; ?></span><span data-prefix>$</span></td>
				</tr>
			</table>
		</article>
		<aside>
