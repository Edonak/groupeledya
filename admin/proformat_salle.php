...
if (isset($_GET['sup'])) {
       ...
       {?> <script type="text/javascript">
                     ...
                     setInterval(function () {
                            window.location.replace('proformat_salle.php')
                                   ...
                                   <tbody>
                                     ...
                                     while ($garde = mysqli_fetch_assoc($requete2)) {  ?>
                                           ...
                                           <tr>
                                               ...
                                               <td><a href="proformat.php?caisse=<?php echo $garde['id']; ?>"><?php echo $garde['nominnation']; ?> </a></td>
                                                <td> <?php echo $garde['nbr_personne']; ?></td>
                                               <td><a href="#"><?php echo $d = $garde['prix']; ?> $</a></td>
                                               
<td class="hidden-480"><a href="proformat_salle.php?caisse=<?php echo $garde['id']; ?>"><i class="fa fa-user-plus 2x"></i> Ajouter </a></td>
...
if (isset($_GET['caisse'])) {
       extract($_GET);
        ...
        $requete2 = mysqli_query($connection,"SELECT *FROM salles where id='$caisse' ORDER BY id DESC");
                                            while ($garde = mysqli_fetch_assoc($requete2)) {
...
$code_proforma=mt_rand();
  ...
  $insertion = $dbo->prepare("INSERT INTO  profrorma(code_proforma,libelle,montant,percepteur,id_percepteur,motif,date_operation) values(?,?,?,?,?,?,?)");
              ...
              $insertion->execute(array($code_proforma,$nominnation,$prix,$username,$id,$motif,$date_operation));
   ...
   <tr>
                                                   ...
                                                   <td><?php echo $garde['libelle']; ?></td>
                                                    <td><?php echo $garde['montant']; ?>$</td>
                                                      ...
                                                      <td><a class="red" href="proformat_salle.php?sup=<?php echo $garde['id']; ?>"><i class="ace-icon fa fa-trash bigger-130"></i></a> </td>
  </tr>
     <?php }
